...
namespace Verity.Ledger.Api.ErrorHandling;

/// <summary>
/// Traduz exceções não tratadas em respostas Problem Details (RFC 9457), sem expor detalhes
/// internos (stack trace, mensagens de infraestrutura) ao cliente — ver docs/security.md.
/// </summary>
